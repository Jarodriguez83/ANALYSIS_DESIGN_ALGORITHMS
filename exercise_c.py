# ==============================================
# PROGRAMA PARA CALCULAR EL CAMBIO DE UNA COMPRA
# UTILIZANDO BILLETES Y MONEDAS DISPONIBLES
# ==============================================
...
# ==============================================
# SECCION DE EXPLICACION DEL PROGRAMA
# ==============================================

print("=========================================")
print("SISTEMA DE CALCULO DE CAMBIO PARA CAJERO")
print("=========================================")
...
# ==============================================
# ENTRADA DEL VALOR DE COMPRA Y PAGO
# ==============================================
...
if V < 0:
    ...
    print("EL PAGO NO ES SUFICIENTE PARA LA COMPRA")
    exit()

print("EL CAMBIO A ENTREGAR ES:", V)


# ==============================================
# LECTURA DE DENOMINACIONES DE MONEDAS
# ==============================================
...
# ==============================================
# LECTURA DE DENOMINACIONES DE BILLETES
# ==============================================
...
# ==============================================
# COMBINA TODAS LAS DENOMINACIONES
# ==============================================
...
if valor_restante != 0:
    ...
    print("\nNO ES POSIBLE ENTREGAR EL CAMBIO EXACTO")
    print("NO HAY SUFICIENTES MONEDAS O BILLETES")
    ...
    print("NUMERO MINIMO DE PIEZAS USADAS:", total_piezas)
